    ...
    public void Update(double elapsedTime, double frameTime) {
        ...
        if (emul_progress) {
            ...
            if (p0 <= p1) { // появился мотоцикл
                ...
                Moto m = new Moto();
                if (!m.setPic(motopic)) {
                    System.err.println("motoico missed");
                }
            ...
            if (p0 <= p2) { // появилась машина
                ...
                Car c = new Car();
                if (!c.setPic(carpic)) {
                    System.err.println("carico missed");
                }
...
//==============================================================================    
    ...
    public void paint(Graphics g) {
        ...
        if (showtime) {
            offScreenGraphics.drawString(str, 15, 15); // отображение таймера        
        }
...
//                    if(lst.get(i) instanceof Car){
//                        offScreenGraphics.drawString( ((Car)lst.get(i)).specCarF1(),300,300);
//                    }
...
//        app.add(rightPan);
        ...
        //frame.setLayout(new GroupLayout(leftPan));
        //frame.getContentPane().add(leftPan).doLayout();
